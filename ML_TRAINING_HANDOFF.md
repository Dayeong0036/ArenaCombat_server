...
| **BranchSizes** | [5] |
| **VectorActionSize** | [5] |
| **정규화 상수** | _maxDistance=55, _maxCooldown=30, _maxSpeed=16, _maxBurstDmg=120, _maxBossPhase=4 |
...
#128  보스 최근 1초 burst 피격 dmg     / 120 (_maxBurstDmg)
```
